...
def _validar_itens_entrega(referencias, descricoes, entregues):
...
def salvar_nova_entrega():
    ...
    try:
        itens = _validar_itens_entrega(
            ...
            request.form.getlist("descricao[]"),
...
def salvar_edicao_entrega(recebimento_id):
    ...
    data = request.form.get("data", "").strip()
    try:
        itens = _validar_itens_entrega(request.form.getlist("referencia[]"), request.form.getlist("descricao[]"), request.form.getlist("quantidade_entregue[]"))
    except ValueError as e:
